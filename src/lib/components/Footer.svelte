...
<footer class='bg-alpha flex flex-col gap-12 pb-12'>
    <div id='logo' class='flex items-center justify-start relative pl-6 pr-10 py-8'>
        <a href="/" class='w-[8.75rem] h-6 text-white'>
            <Bolscher />
        </a>
    </div>
    <article class='flex flex-col h-full justify-center gap-2 px-4'>
        <h4 class='text-white/60 text-sm'>Adres</h4>
        <p class='text-white'>Strootsweg 40</p>
        <p class='text-white'>7547 RW Enschede</p>
    </article>
    <article class='flex flex-col h-full justify-center gap-2 px-4'>
    ...
    <div class='flex flex-col text-white px-4 gap-8 text-sm'>
        <a href='/'>Algemene voorwaarden</a>
        <a href='/'>Privacy statement</a>
        <p class=''>© 2022 Bolscher. Alle rechten voorbehouden</p>
    </div>
</footer>